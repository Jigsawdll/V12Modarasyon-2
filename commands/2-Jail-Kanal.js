...
let salvoembed = new Discord.MessageEmbed().setColor(0x7997ff).setFooter(`Jigsaw ❤ Rascal`).setAuthor(message.author.username, message.author.avatarURL({dynamic: true}))
