...
let salvoembed = new Discord.MessageEmbed().setColor("RANDOM").setFooter(`Jigsaw ❤ Rascal`).setAuthor(message.member.displayName, message.author.avatarURL({dynamic: true}))
